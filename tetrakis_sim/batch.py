...
"""
    ...
    parser.add_argument(
        ...
        type=str,
        default="blackhole",
        choices=["blackhole", "wedge", "none", "singularity"],
        help="Type of defect  to apply",
    )
    parser.add_argument(
        "--outdir",
        type=str,
        default="batch_cli_output",
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Custom prefix for output files (optional)",
    )
    parser.add_argument(
        "--kick",
        type=str,
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help="Singularity radius (default: use --radius)",
    )
    parser.add_argument(
        "--sing_prune_edges",
        action="store_true",
        help="Prune edges at singularity region",
    )
    ...
    if args.defect_type == "blackhole":
        horizon_nodes = find_event_horizon(
            G, removed_nodes, args.radius, center, adjacency_graph=G_pre_defect
        )
    ...
    if args.kick:
        ...
        if initial_node not in G:
            raise ValueError(
                f"--kick node {initial_node} is not in the graph after defect application"
            )
    else:
